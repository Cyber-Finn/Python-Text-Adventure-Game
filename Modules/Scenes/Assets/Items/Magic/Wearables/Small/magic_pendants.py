...
# todo: martry's breathe would make a good upgrade material!
martyr_embrace = item_system.Item(name="Martry's Last Embrace", type = "Pendant", description="A drop of crystallised blood, held in place by threads of intertwining spikes - ready to burrow into flesh",  
                                 interaction_description=
                                 "You pick up the thorny noose — the drop of crystallized blood shimmering under examination.\
                                 \r\nAs you hold it, a strange feeling befalls you.. \
...
game_objects = {
    ...
    #   ensure the name matches the object you added at the top (below the import)
}
